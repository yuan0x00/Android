...
public class ProjectPageBean {
    ...
    private int curPage;
    private List<ProjectItemBean> datas;
    private int offset;
    ...
    public List<ProjectItemBean> getDatas() {
        return datas;
    }

    public void setDatas(List<ProjectItemBean> datas) {
    ...
    public static class ProjectItemBean {
        ...
        public boolean isAdminAddFlag() {
            return isAdminAdd;
        }

        public void setAdminAddFlag(boolean adminAddFlag) {
            isAdminAdd = adminAddFlag;
        }
        ...
        public void setTags(List<ProjectTagBean> tags) {
