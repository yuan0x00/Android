package com.rapid.core.net;

import androidx.annotation.NonNull;

import com.rapid.core.net.client.CoreRetrofitBuilder;
        ...
        if (retrofit == null) {
            synchronized (retrofitLock) {
                if (retrofit == null && !isDefaultRetrofitCreated) {
                    // 创建默认实例
                    retrofit = CoreRetrofitBuilder.getInstance().getRetrofit();
