...
public class AuthInterceptor implements Interceptor {
    ...
    private static final Type BASE_RESPONSE_TYPE = new TypeToken<BaseResponse<Object>>() {
    }.getType();
    ...
    public AuthInterceptor(
        ...
        this(customUnauthorizedCodes, null, null);
    }

    public AuthInterceptor(
            @Nullable int[] customUnauthorizedCodes,
            @Nullable Set<Integer> businessUnauthorizedCodes) {
        this(customUnauthorizedCodes, businessUnauthorizedCodes, null);
    }
    ...
    private record BusinessCheckResult(Response response, boolean businessUnauthorized) {
    }
}
