package com.core.ui.components.popup;
...
public class BasePopupWindow extends PopupWindow {
    ...
    private BasePopupWindow(Builder builder) {
        ...
        // Apply styling
        setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.base_popup_background));
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            this.contentView = LayoutInflater.from(context).inflate(R.layout.base_popup_layout, null);
        }
