...
//
//public class ArticleWebViewActivityBackup extends AppCompatActivity implements DialogHost, ScopedDialogHost {
//
...
//        Intent intent = new Intent(context, ArticleWebViewActivityBackup.class);
