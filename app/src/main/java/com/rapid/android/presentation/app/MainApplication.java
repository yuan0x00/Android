package com.rapid.android.presentation.app;
...
import com.rapid.android.data.session.SessionInitializer;
...
//                    .penaltyDeath()                 // 崩溃定位问题
    ...
    private void initNetWork() {
        CoreRetrofitConfig config = CoreRetrofitConfig.builder()
                .baseUrl("https://www.wanandroid.com/")
                .enableLogging(BuildConfig.DEBUG)
                .allowInsecureSsl(BuildConfig.DEBUG)
                .crashReportEndpointProvider(() -> "https://www.wanandroid.com/app/crash/upload")
                .authFailureListener(AuthSessionManager::notifyUnauthorized)
                .build();
        CoreRetrofitBuilder.configure(config);
        NetApis.init();

        SessionInitializer.restore();
    }
